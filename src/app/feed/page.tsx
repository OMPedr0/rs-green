...
export default function Feed() {
  ...
  return (
    <BackgroundFeed imageURL="https://firebasestorage.googleapis.com/v0/b/rs-green.appspot.com/o/bgfeed.png?alt=media&token=4b319733-4e93-481c-9fbd-2e1a799112f0&_gl=1*ofljg4*_ga*MjAzOTQzNDExMi4xNjkyNzA2OTI1*_ga_CW55HF8NVT*MTY5NzcwOTI2MS4yOS4xLjE2OTc3MDkyODIuMzkuMC4w">

...
const PostDetail = () => {
  ...
  return (
    ...
    //   <div
    //     className="bg-text2 bg-opacity-25 max-w-screen-xl p-8 rounded-lg shadow-lg"
    //     style={{ width: '700px', height: '500px', overflowY: 'auto' }}
    //   >
    ...
    //         <Slider
    //           {...settings}
    //           slidesToShow={post.imageURLs.length > 2 ? 3 : post.imageURLs.length}
    //         >
